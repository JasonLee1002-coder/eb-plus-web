 ...
 * 首度引進炒麵類早餐。
 *
 * 2026-08-16 移除「1987 年／台北市萬華區」：科專計畫書（總部送經濟部的版本）
 * 寫的是「成立於民國 85 年（1996）、總部設於新北市中和區」，兩個版本對不起來。
 * 依內容紅線，沒查證的年份與地點一律不寫，等總部裁示後再補（已列入請總部
 * 填回的資訊確認表 v2 第三節）。
 *
...
const MILESTONES = [
  ...
  },
  {
    label: "落腳",
    title: "第一家店",
    body: "攤車做出穩定的客群之後，有了第一家店面。東方美從這裡開始。",
  },
  {
    label: "轉折",
    title: "把炒麵端上早餐桌",
